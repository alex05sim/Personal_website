...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role:
      "Worked on data-processing and modeling pipelines for solar-cycle time-series analysis.",
    proof: [
      {
        label: "Research context",
        detail: "Berkeley research project focused on forecasting solar activity from noisy periodic time-series data.",
      },
      {
        label: "Artifact gap",
        detail: "A chart, paper excerpt, poster, or approved writeup should be added when available.",
      },
    ],
    constraints: [
      "Solar activity data is noisy, long-horizon, and only approximately periodic.",
      "Research artifacts may need approval before public release.",
      "Forecast quality depends on stable feature extraction, not just model choice.",
    ],
    outcome:
      "Shows applied ML/data-science work on real scientific time-series rather than toy datasets.",
    nextSteps: [
      "Add an approved forecast-vs-observed chart.",
      "Link a research poster or writeup if public release is allowed.",
    ],
    artifactStatus: "planned",
    architecture: [
      { label: "Solar data", detail: "Historical activity series" },
      { label: "Cleaning", detail: "Noise and missing-data handling" },
      { label: "Features", detail: "Cycle and time-series signals" },
      { label: "Models", detail: "Regression / sequence methods" },
      { label: "Validation", detail: "Forecast vs observed behavior" },
    ],
    highlights: [
